...
export function ProvidersSection(props) {
    ...
    return (_jsxs("div", { "data-providers-section": PROVIDERS_LOCALE_NS, style: pageStyle, children: [_jsx("style", { children: providerUiCss }), _jsx("header", { children: _jsx("h2", { style: titleStyle, children: t('title') }) }), showToggle
