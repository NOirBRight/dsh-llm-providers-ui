...
export function ProvidersSection(props) {
    ...
    const renderCard = (item) => {
        ...
        const identity = (_jsxs("div", { className: "c-identity", children: [_jsx("span", { className: "c-brand", children: _jsx(ProviderMark, { providerKey: item.key }) }), _jsxs("div", { children: [_jsxs("div", { className: "c-name-line", children: [_jsx("span", { className: "c-name", children: props.nameOf?.(item.key) ?? summary?.name ?? item.key }), _jsx(ProviderRoleBadge, { ...(role === 'llm' ? {} : { role }) })] }), _jsxs("div", { className: "c-sub", children: [_jsx("span", { className: 'c-dot' + (linked(link) ? ' good' : '') }), t(link), models === undefined ? null : _jsxs(_Fragment, { children: [_jsx("span", { "aria-hidden": "true", children: "\u00B7" }), t('modelCount').replace('{n}', String(models))] })] })] })] }));
        if (detail !== undefined) {
            if (migrated) {
        ...
        return (_jsxs("div", { className: "c-row-grid", "data-provider-row": item.key, "data-provider-role": role, children: [_jsx("div", { className: "c-cell", children: identity }), _jsx("div", { className: "c-mini", children: missing === undefined && primary !== undefined
