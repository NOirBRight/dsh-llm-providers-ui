...
export function ProvidersSection(props) {
    ...
    const renderCard = (item) => {
        ...
        return (_jsxs("div", { "data-provider-slot": "", "data-provider-role": role, style: fallbackWrapStyle, children: [_jsx("span", { style: { ...fallbackBadgeBase, ...(role === 'agent' ? fallbackBadgeAgent : fallbackBadgeLlm) }, children: role === 'agent' ? 'Agent' : 'LLM' }), node] }));
    };
    ...
    return (_jsxs("div", { "data-providers-section": PROVIDERS_LOCALE_NS, style: pageStyle, children: [_jsx("style", { children: providerUiCss }), _jsxs("header", { children: [_jsx("h2", { style: titleStyle, children: t('title') }), _jsx("p", { style: subtitleStyle, children: t('subtitle') })] }), showToggle
