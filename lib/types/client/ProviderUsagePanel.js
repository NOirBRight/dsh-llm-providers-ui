...
function FilterRow(props) {
    return (_jsxs("label", { className: "pu-filter-item", children: [_jsx("input", { type: "checkbox", "aria-label": '在侧栏显示 ' + props.summary.name, checked: !props.hidden, onChange: event => { props.onToggle(event.target.checked); } }), _jsx("span", { className: "pu-mark", children: _jsx(ProviderMark, { providerKey: props.summary.providerKey, fallback: providerInitial(props.summary.name) }) }), _jsx("span", { className: "pu-filter-name", children: props.summary.name })] }));
}
const STATUS_TEXT = {
    loading: '加载中…',
    ready: '暂无额度数据',
