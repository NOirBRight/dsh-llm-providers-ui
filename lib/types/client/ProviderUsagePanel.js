...
function ProviderRow(props) {
    ...
    return (_jsxs("div", { role: "group", className: 'pu-row' + (tone === undefined ? '' : ' pu-' + tone) + (props.active ? ' pu-active' : ''), "aria-label": summary.name + ' ' + (primary === undefined ? STATUS_TEXT[summary.status] : headline), ...title === undefined ? {} : { title }, children: [_jsxs("span", { className: "pu-top", children: [_jsx("span", { className: "pu-icon", "aria-hidden": true, children: providerInitial(summary.name) }), _jsx("span", { className: "pu-name", children: summary.name }), summary.status === 'stale' ? _jsx("span", { className: "pu-stale", children: "\u5DF2\u8FC7\u671F" }) : null] }), _jsx("b", { className: 'pu-primary' + (primary === undefined ? ' pu-empty-text' : ''), children: headline })] }));
}
