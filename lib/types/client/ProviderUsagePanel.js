...
export function ProviderUsagePanel(props) {
    ...
    return (_jsxs("section", { "data-provider-usage-panel": true, "aria-label": "Provider Usage", children: [_jsx("style", { children: providerUiCss + panelCss }), detail === undefined && _jsxs("div", { className: "pu-head", children: [_jsx("span", { className: "pu-title", children: "Provider Usage" }), _jsxs("span", { className: "pu-actions", children: [_jsx("button", { type: "button", className: "pu-icon-btn", "aria-label": "\u9009\u62E9\u4FA7\u680F\u663E\u793A\u7684 Provider", "aria-expanded": filterOpen, onClick: () => { setFilterOpen(open => !open); }, children: _jsxs("svg", { viewBox: "0 0 20 20", "aria-hidden": "true", children: [_jsx("path", { d: "M3 5h8M15 5h2M9 10h8M3 10h2M3 15h6M13 15h4" }), _jsx("circle", { cx: "13", cy: "5", r: "2" }), _jsx("circle", { cx: "7", cy: "10", r: "2" }), _jsx("circle", { cx: "11", cy: "15", r: "2" })] }) }), _jsx("button", { type: "button", className: 'pu-icon-btn' + (props.refreshing === true ? ' pu-spinning' : ''), "aria-label": "\u5237\u65B0\u5168\u90E8", onClick: () => { props.onRefresh(); }, children: _jsx(RefreshIcon, {}) })] })] }), _jsx("div", { className: 'pu-stage' + (detail === undefined ? '' : ' pu-stage-open'), children: detail === undefined ? body : _jsx(UsageDetail, { summary: detail, onBack: closeDetail, onRefresh: () => { props.onRefresh(detail.providerKey); } }) }), filterOpen
