...
const panelCss = [
    ...
    '[data-provider-usage-panel] .pu-title{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:12px;font-weight:500;letter-spacing:.01em;color:var(--dsw-alias-label-secondary)}',
    ...
    '[data-provider-usage-panel] .pu-mark{display:grid;place-items:center;flex:none;width:18px;height:18px;overflow:hidden;opacity:.5}',
    '[data-provider-usage-panel] .pu-logo{display:block;width:18px;height:18px;color:var(--dsw-alias-label-tertiary)}',
    ...
    '[data-provider-usage-panel] .pu-name{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:var(--dsw-alias-label-secondary);font-size:10px;font-weight:400;line-height:12px}',
    '[data-provider-usage-panel] .pu-stale{flex:none;margin-left:auto;color:var(--dsw-alias-label-tertiary);font-size:8px}',
    '[data-provider-usage-panel] .pu-primary{color:var(--dsw-alias-label-secondary);font-size:12px;font-weight:400;line-height:14px;font-variant-numeric:tabular-nums}',
    ...
    '[data-provider-usage-panel] .pu-detail-name{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:13px;font-weight:500;color:var(--dsw-alias-label-secondary)}',
    ...
    '[data-provider-usage-panel] .pu-tip-value{font-variant-numeric:tabular-nums;font-weight:500;font-size:12px;color:var(--dsw-alias-label-secondary)}',
    '[data-provider-usage-panel] .pu-bar{display:block;width:100%;height:6px;overflow:hidden;border:0;border-radius:99px;background:color-mix(in srgb,var(--dsw-alias-label-primary) 10%,var(--dsw-alias-bg-layer-1));accent-color:var(--dsw-alias-state-business-primary)}',
    ...
    '[data-provider-usage-panel] .pu-bar::-webkit-progress-value{background:var(--dsw-alias-state-business-primary);border-radius:99px}',
    '[data-provider-usage-panel] .pu-bar::-moz-progress-bar{background:var(--dsw-alias-state-business-primary);border-radius:99px}',
    '[data-provider-usage-panel] .pu-bar.pu-warn{accent-color:#c47b08}',
    '[data-provider-usage-panel] .pu-bar.pu-warn::-webkit-progress-value,[data-provider-usage-panel] .pu-bar.pu-warn::-moz-progress-bar{background:#c47b08}',
    '[data-provider-usage-panel] .pu-bar.pu-low{accent-color:#d94848}',
    '[data-provider-usage-panel] .pu-bar.pu-low::-webkit-progress-value,[data-provider-usage-panel] .pu-bar.pu-low::-moz-progress-bar{background:#d94848}',
