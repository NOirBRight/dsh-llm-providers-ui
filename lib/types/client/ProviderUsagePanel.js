...
export function ProviderUsagePanel(props) {
    ...
    return (_jsxs("section", { "data-provider-usage-panel": true, "data-pu-skin": "quiet-mid", "aria-label": "Provider Usage", children: [_jsx("style", { children: panelCss }), _jsxs("div", { className: "pu-head", children: [_jsx("span", { className: "pu-title", children: "Provider Usage" }), _jsxs("span", { className: "pu-actions", children: [_jsx("button", { type: "button", className: "pu-icon-btn", "aria-label": "\u9009\u62E9\u4FA7\u680F\u663E\u793A\u7684 Provider", "aria-expanded": filterOpen, title: "\u9009\u62E9\u663E\u793A\u7684 Provider", onClick: () => { setFilterOpen(open => !open); }, children: _jsxs("svg", { viewBox: "0 0 20 20", "aria-hidden": "true", children: [_jsx("path", { d: "M3 5h8M15 5h2M9 10h8M3 10h2M3 15h6M13 15h4" }), _jsx("circle", { cx: "13", cy: "5", r: "2" }), _jsx("circle", { cx: "7", cy: "10", r: "2" }), _jsx("circle", { cx: "11", cy: "15", r: "2" })] }) }), _jsx("button", { type: "button", className: 'pu-icon-btn' + (props.refreshing === true ? ' pu-spinning' : ''), "aria-label": "\u5237\u65B0\u7528\u91CF", title: "\u5237\u65B0\u5168\u90E8", onClick: () => { props.onRefresh(); }, children: _jsxs("svg", { viewBox: "0 0 20 20", "aria-hidden": "true", children: [_jsx("path", { d: "M16.2 7A6.5 6.5 0 1 0 16 13.5" }), _jsx("path", { d: "M16.2 3.8V7H13" })] }) })] })] }), _jsx("div", { className: 'pu-stage' + (detail === undefined ? '' : ' pu-stage-open'), children: detail === undefined ? body : _jsx(UsageDetail, { summary: detail, onBack: () => { setDetailKey(undefined); }, onRefresh: () => { props.onRefresh(detail.providerKey); } }) }), filterOpen
                ? (_jsxs("section", { className: "pu-popover", role: "dialog", "aria-label": "\u4FA7\u680F\u663E\u793A", onKeyDown: event => { if (event.key === 'Escape') {
                        ...
                        setDetailKey(undefined);
                                    ...
                                    ? (_jsx(SortableList, { items: [...matches], getId: summary => summary.providerKey, dragLabel: summary => '调整顺序: ' + summary.name, onReorder: next => { props.onReorder?.(next.map(summary => summary.providerKey)); }, renderItem: summary => (_jsxs("label", { className: "pu-filter-item", children: [_jsx("input", { type: "checkbox", "aria-label": '在侧栏显示 ' + summary.name, checked: !hidden.has(summary.providerKey), onChange: event => { props.onToggleVisibility(summary.providerKey, event.target.checked); } }), _jsx("span", { className: "pu-mark", children: _jsx(ProviderMark, { providerKey: summary.providerKey, fallback: providerInitial(summary.name) }) }), _jsx("span", { className: "pu-filter-name", children: summary.name })] })) }))
                                    : matches.map(summary => (_jsxs("label", { className: "pu-filter-item", children: [_jsx("input", { type: "checkbox", "aria-label": '在侧栏显示 ' + summary.name, checked: !hidden.has(summary.providerKey), onChange: event => { props.onToggleVisibility(summary.providerKey, event.target.checked); } }), _jsx("span", { className: "pu-mark", children: _jsx(ProviderMark, { providerKey: summary.providerKey, fallback: providerInitial(summary.name) }) }), _jsx("span", { className: "pu-filter-name", children: summary.name })] }, summary.providerKey)))] })] }))
                : null] }));
}
