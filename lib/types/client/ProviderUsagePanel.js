...
function UsageTip(props) {
    const summary = props.summary;
    return (_jsxs("div", { className: "pu-tip", role: "dialog", "aria-label": summary.name + ' 额度详情', children: [_jsxs("div", { className: "pu-tip-head", children: [_jsx("span", { className: "pu-tip-name", children: summary.name }), _jsx("span", { className: "pu-tip-sub", children: "\u5269\u4F59\u989D\u5EA6" })] }), summary.windows.length === 0
...
export function ProviderUsagePanel(props) {
    ...
    if (visible.length === 0) {
        ...
        body = (_jsx("div", { className: "pu-rows", children: visible.map(summary => (_jsx(ProviderRow, { summary: summary, active: summary.providerKey === props.currentProviderKey, selected: summary.providerKey === detailKey, onSelect: () => { setFilterOpen(false); setDetailKey(current => current === summary.providerKey ? undefined : summary.providerKey); } }, summary.providerKey))) }));
    }
    return (_jsxs("section", { "data-provider-usage-panel": true, "aria-label": "Provider Usage", children: [_jsx("style", { children: panelCss }), _jsxs("div", { className: "pu-head", children: [_jsx("span", { className: "pu-title", children: "Provider Usage" }), _jsx("span", { className: "pu-count", "aria-label": '已显示 ' + String(visible.length) + ' / 可查询 ' + String(props.providers.length), children: String(visible.length) + ' / ' + String(props.providers.length) }), _jsxs("span", { className: "pu-actions", children: [_jsx("button", { type: "button", className: "pu-icon-btn", "aria-label": "\u9009\u62E9\u4FA7\u680F\u663E\u793A\u7684 Provider", "aria-expanded": filterOpen, title: "\u9009\u62E9\u663E\u793A\u7684 Provider", onClick: () => { setDetailKey(undefined); setFilterOpen(open => !open); }, children: _jsxs("svg", { viewBox: "0 0 20 20", "aria-hidden": "true", children: [_jsx("path", { d: "M3 5h8M15 5h2M9 10h8M3 10h2M3 15h6M13 15h4" }), _jsx("circle", { cx: "13", cy: "5", r: "2" }), _jsx("circle", { cx: "7", cy: "10", r: "2" }), _jsx("circle", { cx: "11", cy: "15", r: "2" })] }) }), _jsx("button", { type: "button", className: 'pu-icon-btn' + (props.refreshing === true ? ' pu-spinning' : ''), "aria-label": "\u5237\u65B0\u7528\u91CF", title: "\u5237\u65B0\u5168\u90E8", onClick: props.onRefresh, children: _jsxs("svg", { viewBox: "0 0 20 20", "aria-hidden": "true", children: [_jsx("path", { d: "M16.2 7A6.5 6.5 0 1 0 16 13.5" }), _jsx("path", { d: "M16.2 3.8V7H13" })] }) })] })] }), _jsx("div", { className: 'pu-scroll' + (visible.length > 6 ? ' pu-scroll-more' : ''), children: body }), detail === undefined ? null : _jsx(UsageTip, { summary: detail }), filterOpen
