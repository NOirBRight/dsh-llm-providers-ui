...
export { ProviderDirectory } from './directory.js';
export { createCodexUsageReader, createCommandCodeUsageReader, createCursorUsageReader, createGrokUsageReader, createOllamaUsageReader, createOpenCodeGoUsageReader, } from './usage.js';
...
function installSectionTransaction(ctx, orderScope, t, directory) {
    ...
    const mount = () => {
        ...
        }, keys => { void orderScope.set('order', keys); }, key => directory.roleOf(key))));
        stopSection = section;
        try {
