...
export function ModelCatalogEditor(props) {
    ...
    return (_jsxs("div", { children: [items.length === 0 ? null : (_jsx("div", { style: { display: 'flex', justifyContent: 'flex-end', marginBottom: 8 }, children: _jsx("button", { type: "button", disabled: disabled, "aria-pressed": !allClosed, style: { ...iconButtonStyle, width: 'auto', minWidth: 96, padding: '0 10px', gap: 6, fontSize: 12 }, onClick: () => {
