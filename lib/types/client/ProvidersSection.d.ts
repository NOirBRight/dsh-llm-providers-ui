...
export declare function bindProvidersSection(listRegisteredKeys: () => readonly string[], subscribe: (listener: () => void) => () => void, readPage: () => {
    ...
    disabled: boolean;
    showSidebarUsage: boolean;
}, onReorder: (keys: string[]) => void, roleOf: (key: string) => ProviderRole, onShowSidebarUsage: (show: boolean) => void, headerOf?: (key: string) => ProviderHeaderOwnership, readUsage?: () => readonly ProviderUsageSummary[], subscribeUsage?: (listener: () => void) => () => void, accountOf?: (key: string) => ProviderAccountSnapshot | undefined, onRefresh?: (key?: string) => void, detailOf?: (key: string) => ProviderDetailOwnership, nameOf?: (key: string) => string | undefined, modelCountOf?: (key: string) => number | undefined): (props: ProvidersSectionSlotProps) => ReactNode;
/**
