				...
				children: [
					jsxs("div", {
						...
						children: [jsxs("div", {
							...
							children: [
								props.models.onToggleAll === void 0 && props.models.onToggle === void 0 ? null : jsxs("button", {
									type: "button",
									...
									children: [jsx(DetailIcon, { path: ICON.expand }), catalogAllOpen(props.models.items, props.models.expanded) ? props.copy.collapseAll : props.copy.expandAll]
								}),
