		...
		*/
		...
		function pickPrimaryWindow(windows) {
			...
			for (const quotaWindow of windows) {
				...
				if (best === void 0 || remaining < (best.remainingPercent ?? Number.POSITIVE_INFINITY)) best = quotaWindow;
			}
		...
		function usageToneClass(remainingPercent) {
			if (remainingPercent !== void 0 && remainingPercent <= 15) return " pu-low";
			if (remainingPercent !== void 0 && remainingPercent <= 35) return " pu-warn";
			return "";
		}
		...
		function windowTooltip(windows) {
			return windows.map((quotaWindow) => quotaWindow.label + " " + windowValueText(quotaWindow) + (quotaWindow.resetsAt === void 0 ? "" : " · 重置 " + quotaWindow.resetsAt)).join("；");
		}
		...
		function ProviderRow(props) {
			...
			return (0, react_jsx_runtime.jsxs)("button", {
				...
				children: [(0, react_jsx_runtime.jsxs)("span", {
					...
					children: shown.map((quotaWindow) => (0, react_jsx_runtime.jsxs)("span", {
						className: "pu-window",
						title: windowTooltip([quotaWindow]),
