		...
		*/
		...
		function UsageTip(props) {
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [(0, react_jsx_runtime.jsxs)("div", {
					className: "pu-tip-head",
					children: [(0, react_jsx_runtime.jsx)("span", {
						className: "pu-tip-name",
						children: summary.name
					}), (0, react_jsx_runtime.jsx)("span", {
						className: "pu-tip-sub",
						children: "剩余额度"
					})]
		...
		function ProviderUsagePanel(props) {
			...
			if (visible.length === 0) body = (0, react_jsx_runtime.jsxs)("div", {
				...
				children: visible.map((summary) => (0, react_jsx_runtime.jsx)(ProviderRow, {
					...
					onSelect: () => {
						setFilterOpen(false);
						setDetailKey((current) => current === summary.providerKey ? void 0 : summary.providerKey);
					}
				}, summary.providerKey))
			});
			return (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					(0, react_jsx_runtime.jsx)("div", {
						className: "pu-scroll" + (visible.length > 6 ? " pu-scroll-more" : ""),
						children: body
					}),
					detail === void 0 ? null : (0, react_jsx_runtime.jsx)(UsageTip, { summary: detail }),
		...
		async function readCodexUsage(rpc, signal) {
			...
			while (!signal.aborted) {
				...
				const quotaSettled = result.ok && record(result.value)?.quotaError !== void 0;
