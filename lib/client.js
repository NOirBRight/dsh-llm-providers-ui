window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		function bindProvidersSection(listRegisteredKeys, subscribe, readOrder, onReorder, roleOf) {
		...
		*/
		...
		exports.ProviderDirectory = ProviderDirectory;
		exports.apply = apply;
		exports.createCodexUsageReader = createCodexUsageReader;
		exports.createCommandCodeUsageReader = createCommandCodeUsageReader;
		exports.createCursorUsageReader = createCursorUsageReader;
		exports.createGrokUsageReader = createGrokUsageReader;
		exports.createOllamaUsageReader = createOllamaUsageReader;
		exports.createOpenCodeGoUsageReader = createOpenCodeGoUsageReader;
