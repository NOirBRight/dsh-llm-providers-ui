...
[data-providers-section] .c-model-card{border:1px solid var(--c-line);border-radius:8px;background:var(--c-bg);padding:10px 12px}
...
/* Provider fields stay on one row: columns share the width and a lone field
   still stops at the prototype width instead of stretching across the card. */
[data-providers-section] .c-extra-grid{display:grid;grid-auto-flow:column;grid-auto-columns:minmax(0,1fr);gap:10px 14px;align-items:end}
[data-providers-section] .c-extra-grid>*{min-width:0;max-width:220px}
...
`;
		...
		const copy = {
			...
			en: {
				...
				windowHourShort: "5-hour",
				windowWeekShort: "Weekly",
				windowMonthShort: "Monthly",
				colConfig: "Setup",
					...
					props.models === void 0 ? null : (0, react_jsx_runtime.jsxs)("section", {
						...
						children: [
							...
							(0, react_jsx_runtime.jsxs)("div", {
								...
								children: [props.models.list, props.models.items === void 0 ? null : (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsx)(SortableList, {
...
`;
		...
		*/
		function windowName(window, t) {
			const canonical = (token, scoped = false) => {
			...
			const mapped = canonical(parts.at(-1)?.trim() ?? "", true);
			if (mapped !== void 0 && parts.length > 1) return [...parts.slice(0, -1).map((part) => part.trim()), mapped].join(" · ");
			const short = window.shortLabel === void 0 ? "" : canonical(window.shortLabel);
			return short === void 0 || label.length > 0 ? label : short;
		}
