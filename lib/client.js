...
`;
		...
		*/
		...
		function ProviderRow(props) {
			...
			const label = summary.name + " " + (primary === void 0 ? STATUS_TEXT[summary.status] : headline) + (summary.status === "stale" ? " · 已过期" : "");
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [(0, react_jsx_runtime.jsxs)("div", {
					...
					children: [(0, react_jsx_runtime.jsx)("div", {
						...
						children: summary.status === "stale" ? "剩余额度 · 已过期" : "剩余额度"
		...
		function ProviderUsagePanel(props) {
			...
			if (visible.length === 0) body = (0, react_jsx_runtime.jsxs)("div", {
				className: "pu-empty",
				children: [
					(0, react_jsx_runtime.jsx)("div", { children: providers.length === 0 ? "暂无可查询的 Provider" : "没有显示的 Provider" }),
						...
						children: [
							...
							(0, react_jsx_runtime.jsxs)("div", {
								...
								children: [(0, react_jsx_runtime.jsx)("button", {
									...
									children: "显示全部 " + String(providers.length) + " 个"
