		...
		*/
		...
		function cardTitle(windows) {
			...
			return windows.map((quotaWindow) => {
				...
				return quotaWindow.shortLabel + " · " + windowValueText(quotaWindow) + (reset === void 0 ? "" : " · " + reset + " 重置");
			}).join(" · ");
		}
		...
		function ProviderRow(props) {
			...
			const headline = primary === void 0 ? summary.status === "ready" ? "—" : STATUS_TEXT[summary.status] : windowValueText(primary);
								...
								children: [
									...
									matches.map((summary) => (0, react_jsx_runtime.jsxs)("label", {
										...
										children: [
											...
											(0, react_jsx_runtime.jsx)(ProviderMark, {
												providerKey: summary.providerKey,
												fallback: providerInitial(summary.name)
											}),
											(0, react_jsx_runtime.jsx)("span", {
